...
param containerAppName string = 'bookrecommender-api'

@description('Location for all resources')
param location string = resourceGroup().location

@description('Environment for the container app')
param environmentName string = 'bookrecommender-env'

@description('Container image to deploy')
param containerImage string = 'ghcr.io/kiki-sen/proto/bookrecommender-api:latest'
